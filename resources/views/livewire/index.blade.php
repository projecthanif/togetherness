    ...
    <main>
        ...
        <section class="gj do ir hj sp jr i pg">
            ...
            <div class="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r">
                ...
                <img src="{{asset('pic.png')}}" alt="team members" class="h q r ua" @style('margin-top:50px') />
            </div>
                ...
                <div class="tc _o">
                    <div class="animate_left jn/2">
                        ...
                        <p class="fq text-center">
                            To create a platform of opportunities for young people with a robust toolkit to elevate
                            ideas
                            and pursue entrepreneurship
                            <br>
                            ...Solving African Most Complex Problem Through Technology, Innovation, Collaboration
                            And
                            Inclusion.
                        </p>
                    </div>
                ...
                <div class="tc wf gg qq">
                    ...
                    <div class="animate_left xc gn gg jn/2 i">
                        <div>
                            ...
                            <img src="{{asset('team1.jpg')}}" alt="About" class="ib"/>
                            <img src="{{asset('team2.jpg')}}" alt="About"/>
                        </div>
                        <div>
                            <img src="{{asset('images/shape-06.svg')}}" alt="Shape"/>
                            <img src="{{asset('team3.jpg')}}" alt="About" class="ob gb"/>
                    ...
                    <div class="animate_right jn/2">
                        {{-- <h4 class="ek yj mk gb">ABOUT</h4> --}}
                        <h2 class="fk vj zp pr kk wm qb">
                            WE ARE UBUNTU COMMUNITY
                        </h2>

                        <p>
                            <q class="uo">We can't solve our problems with the same thinking we used to create them.</q>
                            -albert einstein
                        </p>
                    </div>
                </div>
        ...
        <section class="i pg ji gp uq">
            ...
            <div class="bb ze i va ki xn xq jb jo">
                <p class="uo text-justify">TOGETHERNESS SUPREME NETWORK AFRICA is a Pan-African integrated social
                    innovation
                    community founded in 2018. It is a platform that facilitates creativity and innovation
                    development, with
                    the mission to foster regional prosperity by opening door steps to new opportunities and
                    creating an
                    accelerating hub that cultivates a consolidating tech structure that empowers business
                    development and
                    entrepreneurship through collaborative and inclusive growth network.
                </p>
                <br>
                <p class="uo text-justify">
                    We work with the vision to nurture the ideas of young talents and creative minds… creating a
                    platform
                    that allows them to explore their evolving purpose and realize an impactful existence while
                    providing
                    them access to a meaningful living through tech support system, innovation and capacity building
                    programs and to create an enabling environment to empower skills and opportunity to drive
                    lucrative
                    ideas, with the goal to promote human capital development and achieving an equitable continent.
                </p>
            </div>
        </section>
        ...
        <section class="lj tp kr pn">
            ...
            <!-- Section Title Start -->
            <div x-data="{ sectionTitleText: `MISSION` }" style="margin-top:10px">
                <div class="animate_top bb ze rj ki xn vq">
                    <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
                </div>
            </div>
            ...
            <div class="bb ze ki xn yq mb en">
                <p class="uo">
                    To alleviate poverty and inspire youth development through technology, innovation and
                    inclusion…facilitating youth empowerment and skill acquisition projects.
                </p>
            </div>
        </section>
        <!-- ===== Services End ===== -->
        ...
        <section class="i pg fh rm ji gp uq">
            <!-- Section Title Start -->
            <div x-data="{ sectionTitle: `FIVE GIANT PLANS.` }">
                <div class="animate_top bb ze rj ki xn vq">
                    <h2 x-text="sectionTitle" class="fk vj pr kk wm on/5 gq/2 bb _b">
                    </h2>
                    {{-- <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p> --}}
        ...
        <section class="pg pj vp mr oj wp nr">
            <div class="wc qf pn xo ng">
                ...
                <div class="animate_top sg oi pi zq ml il am cn _m">
                    ...
                    <h4 class="ek zj kk wm nb _b">INNOVATION</h4>
                    <p>Promoting tech acceleration programs for social development.</p>
                </div>

                <!-- Service Item -->
                <div class="animate_top sg oi pi zq ml il am cn _m">
                    <img src="images/icon-07.svg" alt="Icon"/>
                    <h4 class="ek zj kk wm nb _b">TRAINING</h4>
                    <p>Promoting digital skill training and educational projects.</p>
                </div>

                <!-- Service Item -->
                <div class="animate_top sg oi pi zq ml il am cn _m">
                    <img src="images/icon-05.svg" alt="Icon"/>
                    <h4 class="ek zj kk wm nb _b">DEVELOPMENT</h4>
                    <p>Creating a forum for capacity building.</p>
                </div>
            </div>
            {{-- </div> --}}
        </section>
        ...
        {{--        <section class="pg pj vp mr oj wp nr">--}}
        {{--            <div x-data="{ sectionTitle: `OUR PROGRAMS.`, sectionTitleText: `WE ARE BUILDING THE GREATEST PLATFORM TO ENABLE AFRICAN ENTREPRENEURS AND INNOVATORS EXPLORE.`, sectionTitleText2: `OUR MISSION FOR THIS IS TO CREATE ECONOMIC OPPORTUNITIES FOR YOUNG PEOPLE TO LEVERAGE ON.` }">--}}
        {{--                <div class="animate_top bb ze rj ki xn vq">--}}
        {{--                    <h2 x-text="sectionTitle" class="fk vj pr kk wm on/5 gq/2 bb _b">--}}
        {{--                    </h2>--}}
        {{--                    <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>--}}
        {{--                    <p class="bb on/5 wo/5 hq" x-text="sectionTitleText2"></p>--}}
        {{--                </div>--}}
        {{--            </div>--}}
        {{--        </section>--}}
        <!-- ===== Projects End ===== -->
        ...
        <section class="pj vp mr">
            ...
            <section class="pg pj vp mr oj wp nr">
                <!-- Section Title Start -->
                <div
                    x-data="{ sectionTitle: `PARTNERSHIP.`, sectionTitleText: `TOGETHERNESS SUPREME NETWORK AFRICA opens to partner with African and International Organizations, Visionary Private Organizations, Educational Foundation and Corporate Establishment to provide better access to advance learning, innovation empowerment and acceleration programs for young innovators and entrepreneurs.` }">
                    <div class="animate_top bb ze rj ki xn vq">
                        <h2 x-text="sectionTitle" class="fk vj pr kk wm on/5 gq/2 bb _b">
                        </h2>
                        <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
            ...
            <div class="bb ze i va ki xn br">
                <div class="tc uf sn tn xf un gg">
                    <div class="animate_top me/5 ln rj">
                        ...
                        <p class="ek bk aq">Volunteers</p>
                    </div>
                    <div class="animate_top me/5 ln rj">
                        <h2 class="gk vj zp or kk wm hc">10</h2>
                        <p class="ek bk aq">Fellows</p>
                    </div>
                    {{--                    <div class="animate_top me/5 ln rj">--}}
        ...
        <section id="support" class="i pg fh rm ji gp uq">
            ...
            <!-- Section Title Start -->
            <div x-data="{ sectionTitle: `Let's Stay Connected`, sectionTitleText: `` }">
                <div class="animate_top bb ze rj ki xn vq">
                    <h2 x-text="sectionTitle" class="fk vj pr kk wm on/5 gq/2 bb _b">
                    </h2>
                    <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
                ...
                <div class="tc uf sn tf rn un zf xl:gap-10">
                    <div class="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
                        ...
                        <div class="fb">
                            ...
                            <p><a href="mailto:info@tsnafrica.com">info@tsnafrica.com</a></p>
                        </div>
                        <div class="fb">
                        ...
                        <div class="fb">
                            <h4 class="wj kk wm cc">Info Email</h4>
                            <p><a href="mailto:info@tsnafrica.com">info@tsnafrica.com</a></p>
                        </div>
