    ...
    <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
        <div class="vd to/4 tc wf yf">
                <a href="/" @style('width:50%')>
                    <div class="img">
                        <img class="om" src="{{ asset('togetherness.jpg') }}" alt="Logo Light" />
        ...
        <div class="vd wo/4 sd qo f ho oo wf yf" :class="{ 'd hh rm sr td ud qg ug jc yh': navigationOpen }">
            <nav>
                <ul class="tc _o sf yo cg ep">
                    ...
                    <li><a href="{{ route('program') }}" class="xl" :class="{ 'mk': page === 'home' }">Program</a></li>
                    <li><a href="{{ route('services') }}" class="xl" :class="{ 'mk': page === 'home' }">Services</a></li>
                    <li><a href="{{ route('blog') }}" class="xl" :class="{ 'mk': page === 'home' }">Blog</a></li>
                    <li><a href="{{ route('store') }}" class="xl" >Gallery</a></li>
                </ul>
            </nav>
        </div>
